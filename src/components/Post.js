                                ...
                                <div className="col-md-12">
                                    <div className="well well-sm">
                                        <form className="form-horizontal" method="post">
                                            <fieldset>
                                                <legend className="text-center header">Add new post to make pdf</legend>
                                                ...
                                                <div className="form-group">
                                                    <button type="button" onClick={this.sunmitPost} className="btn btn-secondary btn-lg">Submit</button>
                                                </div>
                                            </fieldset>
                                        </form>
                                    </div>
